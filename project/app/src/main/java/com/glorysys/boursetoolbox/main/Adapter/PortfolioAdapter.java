...
private PortfolioViewHolder.onClickListener onClickListener;
    public PortfolioAdapter(List<NamadsDataSample> namadsDataSampleList,PortfolioViewHolder.onClickListener onClickListener) {
        this.onClickListener=onClickListener;
        this.namadsDataSampleList = namadsDataSampleList;
    }
    ...
    public PortfolioViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.namads_simple_data_layout, parent, false);
        return new PortfolioViewHolder(view,onClickListener);
    }

    @Override
    public void onBindViewHolder(@NonNull PortfolioViewHolder holder, int position) {
        holder.onBind(namadsDataSampleList.get(position));
    ...
    public static class PortfolioViewHolder extends RecyclerView.ViewHolder {
        ...
        public PortfolioViewHolder(@NonNull View itemView,onClickListener onClickListener) {
            super(itemView);
            this.onClickListener=onClickListener;
        ...
        private void onBind(final NamadsDataSample namadsDataSample) {
            ...
            TV_LastPricePercent.setText(namadsDataSample.getLastPricePercentage() + " %");
            TV_LastPrice.setText(String.valueOf(namadsDataSample.getLastPriceAmount()));
            TV_LastDealPercent.setText(namadsDataSample.getLastDealPercentage() + " %");
            ...
            button_FAV.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onClickListener.onPortfolioFavButtonClick(namadsDataSample);
                }
            });
            ///////
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    onClickListener.onPortfolioItemClick(namadsDataSample);
                }
            });
        }

        public interface onClickListener{
            void onPortfolioItemClick(NamadsDataSample namadsDataSample);
            void onPortfolioFavButtonClick(NamadsDataSample namadsDataSample);
        }
